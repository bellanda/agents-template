...
class Models:
    ...
    class Chutes:
        ...
        GLM_5_TURBO = ModelConfig("zai-org/GLM-5-Turbo", "chutes", reasoning=True)
    ...
    class Google:
        GEMINI_3_1_PRO_PREVIEW = ModelConfig("gemini-3.1-pro-preview", "google", thinking=True)
        GEMINI_3_FLASH_PREVIEW = ModelConfig("gemini-3-flash-preview", "google", thinking=True)

    class OpenAI:
        GPT_5_4_NANO = ModelConfig("gpt-5.4-nano", "openai", reasoning=True, reasoning_effort="high")
    ...
    class NVIDIA:
        NEMOTRON_3_SUPER_120B_A12B = ModelConfig("nvidia/nemotron-3-super-120b-a12b", "nvidia", thinking=True)
        QWEN3_5_122B_A10B = ModelConfig("qwen/qwen3.5-122b-a10b", "nvidia", thinking=True)
